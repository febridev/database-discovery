...
from database_discovery.v1.scrap_service.database_service.database_prod.database_detail_PROD import get_database_list, get_remote_connection
...
def main():
    ...
    for db_info in db_list:
        ...
        log_format("info", f"[Main] - Completed processing get list size table and list index  for database {db_name} on {ip_address}.")
